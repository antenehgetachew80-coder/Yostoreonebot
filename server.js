...
'12': 'Answer 12: Electric Pink #FF00BF: Playful, energetic, modern, bold. Used by brands wanting to stand out (e.g., Lyft).',
'13': 'Answer 13: Pink #E91E63: Compassion, love, youthful energy. Often associated with romance and nurturing.',
...
function sendMessage(recipientId, text) {  axios.post(`https://graph.facebook.com/v18.0/me/messages?access_token=${PAGE_ACCESS_TOKEN}`, {    recipient: { id: recipientId },    message: { text: text }  })  .then(() => {    console.log('Message sent successfully');  })  .catch(error => {    console.error('Error sending message:', error.response ? error.response.data : error.message);  });}
